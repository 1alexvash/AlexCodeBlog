...
But jokes aside, why would you send a HARD and complex letter when you can send an EASY letter?
...
No wonder why people who raise to the top of the social hierarchy are commonly ones who are ones who are the most articulate. (\* There's an entire book discussing this idea: [The Elephant in the Brain](https://www.amazon.com/Elephant-Brain-Hidden-Motives-Everyday-ebook/dp/B077GZT9Q1/))
...
I'm a bit of bias, as I like LanguageTool so much, I'm even paying for the premium version, which is something I definitely don't recommend, as the premium version has the very exact same set of features.
...
Of course, in this article I have made a bit too strong case for "purity of writing", but it more complex than that. Good communication is more than just a text with no typos. There are many more elements to it than simply writing without typos, but it is really a foundation, like in hygiene, it all starts from washing your hands, and then you build one brick upon another one.

There are, of course, exceptions to it. In non-professional life, we can be intentionally sloppy while texting to make something fun, or we're just playing dumb with our friends. So context matters.

Therefore, if this is a professional context, let's be the best we can be, and I hope the LanguageTool extension can bring your best.
