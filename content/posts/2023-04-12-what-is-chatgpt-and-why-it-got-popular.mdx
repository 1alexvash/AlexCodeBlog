...
One fun example of similar AI is [This person does not exist](https://this-person-does-not-exist.com/en).

This AI network generates a realistic face of the person who does not really exist.

### AI history

There was a lot of hype since the release of ChatGPT, but in fact AI is not entirely a new thing, it's been around for decades, but it's gained popularity only recently.
...
* Answer your questions\
  ...
  Generating text or create stories\
...
This network is not only capable of generating human language, but also understands the whole context of the entire conversation.
