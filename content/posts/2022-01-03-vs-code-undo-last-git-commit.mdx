...
heroImage: /post-images/2022-01-03-vs-code-undo-last-git-commit.webp
draft: false
tags:
  - Git
  - VSCode
...
*(One last detail: this command doesn't remove files you committed, just moves them in the staging area)*
