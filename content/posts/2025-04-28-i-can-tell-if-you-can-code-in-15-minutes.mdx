...
This one is for some reason got very popular nowadays. It's where an interviewer asks you lots of questions like: "What’s the event loop in JS?", "What is Tailwind and did you work with it?", "Why do we need TypeScript?", "In CSS, what’s the difference between `fixed` and `static` properties" and etc.
