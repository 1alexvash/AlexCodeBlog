...
draft: false
audioVersion: 'https://vocaroo.com/17n87lDEapLb'
tags:
  - TechnicalInterview
---

This is a little bit of a wild story, but a year ago I had to hire a person to code with me on the same team, and I decided to reinvent the classical technical interview approach.

So to see the problem with the traditional approach, we have to look at two common ways to assess a candidate's competence:

**#1 Theory based knowledge**

This one for some reason got very popular nowadays. It's where an interviewer asks you lots of questions like: "What’s the event loop in JS?", "What is Tailwind and did you work with it?", "Why do we need TypeScript?", "In CSS, what’s the difference between `fixed` and `static` properties" and etc.
...
I don't need to ask you some LeetCode question or the knowledge of 2D matrices, but the actual coding test will show it all!
