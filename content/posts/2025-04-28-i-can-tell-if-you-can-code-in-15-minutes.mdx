...
And also this is not a very common type of interview tasks, right? Creating a game, that's a bit abstract, right? - But that's exactly, why this task works so well, at your work you are likely to work for some company domain that works in a domain you don't have 
