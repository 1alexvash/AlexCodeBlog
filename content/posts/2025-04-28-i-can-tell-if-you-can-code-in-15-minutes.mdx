...
As let's be real, this task is sort of a trick task, in 15 minutes you won't be able to complete that project – but this is not what asked of you if you are paying the attention.

And also this is not a very common type of interview tasks, right? Creating a game, that's a bit abstract, right? - But that's exactly, why this task works so well, at your work you are likely to work for some abstract domain like fitness, medicine or maybe just finance you don't have 100% understanding of, but that's not required and not asked for, what's asked for is being able and willing pick up knowledge on the go.

And the Snake game is a perfect example of that, you are a game developer not the web developer, right? But at the same time you are exactly familiar with the wave this child game works, its rules, its mechanics and the way it looks, so it is still relatable and familiar.
