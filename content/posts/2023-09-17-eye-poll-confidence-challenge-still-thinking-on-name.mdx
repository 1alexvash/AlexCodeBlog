...
I had to restart the experiment

restart experiment after 20 approaches

actually 150 approaches

queez time and rejection rate

6 hours

Another man just just approached me asking how the study is going on  Or if anything has changed

After 73 woman: does not matter as there's a dignity to this person

"sort by two categories, interesting responses  and rejections

"

delegate to asya to make infographhics, demographics, age, chance to like your own eye color
