...
It was a web application where I was handed over to finish a piece of functionality by a much more experienced developer than me. Where we basically had an app layout with 5 states. For every state, we loaded a unique component, so the code looked like this in React
