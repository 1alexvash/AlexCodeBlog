...
For two reasons: First, this content might run out meanwhile, leaving you bored with worse quality content overtime. Second, this top ranking content might not have been your cup of tea in the first place to begin with.

So the platform goes really advance, and starts noticing your patterns among other users.

For example, Netflix might have noticed that you are really like John; you both liked the same two last movies you watched. And it notices that John just watched "Don't look up" and really liked it, so Netflix pushes it really hard in your feed, so you are paying attention as it knows you might very well really like it.
...
AI advancements also, did not pass medicine. There are some models promising to predict and diagnose cancer better than experiencing surgeons ([1](https://www.theguardian.com/society/2023/apr/30/artificial-intelligence-tool-identify-cancer-ai), [2](https://www.rsna.org/news/2023/june/ai-improves-lung-cancer-detection))

AI models like this really give hope to humanity and promise the future to be brighter than it is right now.

## Summary

In this article, I tried to give you some historical context of the AI models that's been  around for some quite time, so you are better aware of what's coming in the future. As we're going to be surrounded by more and more smart algorithms. It is important to know about them.

As there are practical AI models just for everything. For farmers to grow better crops, for doctors to treat their patients better, and even for coaches to build better athletes.

So let's brace ourselves for this exciting upcoming future, and maybe even one day you'll build some AI model to make this world better.
