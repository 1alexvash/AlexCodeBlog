...
Generally password sharing is potentially unsafe operation, but sometimes this is necessary evil.

Like in the following cases:

1. You work for a small agency, and it can't afford to buy some expensive piece of software or license, so your company just shares passwords
