...
(GPT 4, which comes as an addition with GPT Plus version, is much better at solving math problems compared to GPT 3.5 which tends to hallucinate and get it wrong quite often)
