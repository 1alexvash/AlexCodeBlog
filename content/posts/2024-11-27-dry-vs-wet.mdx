...
draft: false
audioVersion: 'https://vocaroo.com/1iYtg4mIPqZt'
tags:
  - Patterns
---
...
It might be tempting to discuss and debate those principles endlessly without really realizing the real problem underneath them, and it is to actually solve problems, and don't get yourself in troubles.

So the story goes like this:

A younger software engineer (who has got 5 years of experience) recently got a new job at a new company and this person has got a 🎓 mentor who is a software engineer with 10 years of experience.
...
The senior engineer answers, *“Wrong!”. It might look like a clever idea, but this is what going to get you in the trouble further down the line. Right now, in development it might look like those both pages use the same components, so it's good to refactor, and to reuse parent components for both of them, but just with different properties, but the problem is that in 2 - 3 sprint iterations those two pages aren't going to look nothing alike, so you are just going to overspend time refactoring and overcomplicating simple components which will try to manage all the possible complex cases in the world.*

So the right answer is, *"Just copy and paste! `Ctrl + C`, `Ctrl + V`!",*

It's really an unexpected story and the plot twist, when I heard this story for the first time as I didn't even consider the second option as an option. I just was thinking in terms of the first younger stubborn programmer who needs to refactor everything, in order to make the "code clean".

> Sometimes the wrong way is the right way

And this is what's the business sometimes really needs and requires and even for a 🧑‍💻 developer like yourself as it just a faster and more efficient way to do things sometimes, so that's the wrap of a valuable lesson I learned.
