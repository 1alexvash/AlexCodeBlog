...
In this demo, I'm showing how this can be done exactly.

![](/post-images/animation-demo-for-git-remote-undo.gif "How to undo git remote commit")

### Caveats

1. This trick might not work if the repository is protected (A possible case if you are working for a huge organization)
2. Git history rewrites are potentially dangerous if you don't know what you are doing (This one is self-explanatory, but I still need to give this warning)

Otherwise, this is a really nice way to keep the git history clean.
