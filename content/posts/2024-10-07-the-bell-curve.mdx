...
Also, intelligence is not the only variable predicting the success in life, even though the authors of this book want to make it look so, but there are some other parameters in your control like your personality, if you are naturally very extroverted then you are likely to do good in sales, where you'll be encountering many human interactions, so that's an edge it just stupid for you not to use!
